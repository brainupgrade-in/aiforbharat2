    ...
    <div className="space-y-3">
      ...
      {location && (
        <>
          ...
          {/* Share scan result — Web Share API (system share sheet) on mobile,
              WhatsApp URL fallback on desktop. Replaces the old `<a href=wa.me>`
              that silently failed on some Android browsers. */}
          {scanResult && (
            <button
              type="button"
